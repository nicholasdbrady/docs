---
title: Foundry Developer Platform
description: "What is Azure AI Foundry?"
icon: "house"
---
...
* From the **breadcrumb navigation** section
    ...
    * A [!INCLUDE [hub-project-name](includes/hub-project-name.md)] displays **(Hub)** on the second line
    ...
    ![Screenshot shows both a Foundry and hub based project in the breadcrumb navigation](https://learn.microsoft.com/en-us/azure/ai-foundry/media/how-to/projects/breadcrumb.png)
...
* From the **All resources** page
    ...
    * A [!INCLUDE [hub-project-name](includes/hub-project-name.md)] displays **(Hub)** as the parent resource
    ...
    ![Screenshot shows both a Foundry and hub based project in the All Resources page](https://learn.microsoft.com/en-us/azure/ai-foundry/media/how-to/projects/all-resources.png)
...
<Update label="2025-07-03" description="v0.1.0" tags={["Portal"]} img="https://mintlify-assets.b-cdn.net/screenshot-2025-07-03-123335.png">
  ## Playground update
  ![Screenshot-2025-05-28-123335.png (1903×921)]("https://mintlify-assets.b-cdn.net/hero-light.png")
  This is how you use a changelog with a label, description,
  and tags.
</Update>
<Update label="July 2025" tags={["Portal"]} description="Playground update">
